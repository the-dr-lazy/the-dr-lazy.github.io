...
branch
به برنامه شماست تا برنامه شما یک جرعه هوشمندانه‌تر رفتار کنه.
...
حالا مضمون عنوان پست نباید ثقیل جلوه کنه براتان.
**هدف هر سه این
algebraic structure
ها
abstract
...
Maybe functor
را کشف کردیم!
ولی من هنوز راضی نیستم و نیاز دارم یک وهله دیگه در
abstraction
پیش برم و از
ad-hoc polymorphism
استفاده کنم چون تایپ‌هایی که توانایی تشکیل
Functor
را دارند مثل
Maybe
زیاد هستند.
...
فرض کنید یک فرم دارید که دو ورودی
username
و
password
داره و ممکن مقداری داشته باشه و یا مقداری نداشته باشه و در نتیجه تصمیم میگیرید که با
Maybe
پرزنتش کنید.
...
و همچنین فانشکشنی دارید با نام
findUserByUsername
...
(معصوم‌تر از این فانشکن هم داریم؟)
