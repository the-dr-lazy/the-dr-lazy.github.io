...
export function component({ title, ...props }: Props) {
    ...
    const blockClassName = cc([classNames.block, isReady && classNames.modifiers.ready])

    // TODO: Handle censorship

    return (
        <div className={blockClassName}>
            <YouTube {...props} containerClassName={classNames.elements.iframe} opts={opts} onReady={handleReady} />
