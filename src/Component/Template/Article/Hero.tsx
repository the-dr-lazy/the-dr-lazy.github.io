...
export function component(props: Props) {
    ...
    const hasHeroImage = hero && Object.keys(hero.full).length !== 0 && hero.full.constructor === Object
    ...
    return (
        <div className={classNames.block}>
            ...
            <div className={classNames.elements.image} id="ArticleImage__Hero">
                {hasHeroImage ? <Image.component src={hero.full} /> : <Image.Placeholder.component />}
            </div>
        </div>
    )
}
