...
export function component() {
  ...
  return (
    <div className={classNames.block}>
      <Heading.h3 className={classNames.elements.heading}>
        {translation.subscription.heading}
      </Heading.h3>
      <Paragraph.component
        className={classNames.elements.subheading}
        dangerouslySetInnerHTML={translation.subscription.subheading}
      />
      <form
        className={classNames.elements.form}
      ...
      >
        ...
        />
        <Button.component
          className={classNames.elements.submit}
