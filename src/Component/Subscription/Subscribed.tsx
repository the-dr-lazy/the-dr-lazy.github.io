...
export function component(): VDOM {
    ...
    return (
        <div className={classNames.block}>
            <Paragraph.component className={classNames.elements.message}>{translation.subscription.subscribed}</Paragraph.component>
            <button className={classNames.elements.resubscribe} onClick={onResubscribe} data-a11y="false">
