...
type Props = { theme: Theme } & Omit<JSX.IntrinsicElements['button'], 'onClick' | 'aria-label' | 'title'>
...
export function component({ theme, ...props }: Props) {
    ...
    return (
        <button {...props} onClick={onToggleTheme} data-a11y="false" aria-label={title} title={title}>
